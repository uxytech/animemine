        ...
        <>
            {(epsData && animeData && newsAnimeData && ongoingAnime.status === "success") ? (
                ...
                <Helmet>
                    ...
                    <meta
                    name="description"
                    content={`Nonton Anime ${epsData.title} - Animemine`}
                    />
                    <meta name="robots" content="index, follow" />
                    <meta
                    property="og:title"
                    content={`Nonton ${epsData.title} - Animemine`}
                    />
                    <meta
                    ...
                    <meta name="twitter:title" content={`Nonton ${epsData.title} - Animemine`} />
                    <meta name="twitter:card" content="summary_large_image" />
                    ...
                    content="Nonton Anime Online Sub Indo Gratis di Animemine"
                    />
                    </Helmet>
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-7 py-7 px-3 md:px-7 bg-bg-animemine text-white">
                    <div className="lg:col-span-7">
                        <div>
                            ...
                            <Navigation 
                                ...
                                slug={epsData.id}
                            />
                            <div className="my-3 p-2 text-sm md:text-base border-animemine border font-poppins">
                                <div className="flex gap-2 font-semibold items-center justify-center ">
                                    <p>Kualitas : </p>
                                    <button className={streamQuality === 'sd' ? `py-1 px-2 rounded-sm bg-animemine` : `py-1 px-2 rounded-sm`} onClick={() => setStreamQuality('sd')}>SD 480p</button>
                                    <button className={streamQuality === 'hd' ? `py-1 px-2 rounded-sm bg-animemine` : `py-1 px-2 rounded-sm`} onClick={() => setStreamQuality('hd')}>HD 720p</button>
                                </div>
                    ...
                    <div className="lg:col-span-3 mt-0 lg:mt-16 px-3">
                        <Title>Berita</Title>
                        <div className="bg-bg-animemine-semi">
                            <Aside>
                                {
