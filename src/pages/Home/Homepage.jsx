...
const Homepage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Animemine - Streaming Anime Sub Indo</title>
                <meta
                name="description"
                ...
                <meta
                property="og:title"
                content="Animemine - Streaming Anime Sub Indo"
                />
                <meta
                ...
                <meta name="twitter:title" content="Animemine - Streaming Anime Subtitle Indonesia Secara Gratis" />
            ...
            {(latestAnimeData.status === "success" && newsAnimeData) ? (
                <>
                    <Hero />
                    <div className="main gap-5 px-7 pt-10 grid lg:grid-cols-9 grid-cols-1 bg-bg-">
                        <div className="lg:col-span-6 lg:mx-5 lg:px-10">
                            ...
                            <div className="latest mb-5">
                                <div className="flex justify-between items-center">
                                    ...
                                    <a href="/ongoing/page/1"className="text-white font-semibold transition-all hover:text-animemine font-poppins text-xs md:text-sm">Lihat Semua {">>"}</a>
                                </div>
                                <Cards>
                                    {
                            ...
                            <div>
                                <div className="flex justify-between items-center">
                                    ...
                                    <a href="/completed/page/1" className="text-white font-semibold transition-all hover:text-animemine font-poppins text-xs md:text-sm">Lihat Semua {">>"}</a>
                                </div>
                                <Slider>
                                    {
