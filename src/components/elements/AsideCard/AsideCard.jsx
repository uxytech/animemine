        ...
        <>
            <div className="aside-card py-2 overflow-hidden text-white">
                ...
                <div className="detail px-2">
                    <a href={href} target="_blank" className="font-bold text-[16px] hover:text-animemine transition-all duration-200">{title}</a>
                    <div>
                        ...
                        <div className="topics flex gap-2 mt-2">
                            {
                                topics.join(', ').split(',').map((topic, index) => (
                                    <p className="text-xs text-wrap py-[1px] px-2 text-white bg-animemine rounded-lg" key={index}>
                                        {topic}
                                    </p>
