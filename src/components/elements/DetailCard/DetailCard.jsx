    ...
    return(
        <div className="grid md:grid-cols-7 gap-3 py-5 px-6 place-content-center font-inter">
            ...
            <div className="md:col-span-5 text-center md:text-left">
                ...
                <p className="mt-5 text-sm md:text-base"><span className="font-semibold">Animemine</span> merupakan situs tempat nonton anime <span className="font-semibold">{title}</span> subtitle indonesia secara gratis</p>
            </div>
        </div>
    )
}
